"""Structure the ILThermo surface tension liquid-gas raw file into a cleaned CSV output."""
...
PROPERTY_SLUG = "surface_tension_liquid_gas"
PROPERTY_NAME_PAT = r"Surface tension liquid-gas"
