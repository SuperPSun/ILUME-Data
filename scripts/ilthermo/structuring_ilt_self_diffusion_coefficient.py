"""Structure the ILThermo self-diffusion coefficient raw file into a cleaned CSV output."""
...
PROPERTY_SLUG = "self_diffusion_coefficient"
PROPERTY_NAME_PAT = r"Self diffusion coefficient"
...
_standardize_property_value = build_linear_standardizer(
    quantity_name="self-diffusion coefficient",
    output_unit="10^-9*m^2/s",
    unit_factors={
        "m^2/s": 1e9,
        "m2/s": 1e9,
        "10^-9*m^2/s": 1.0,
