"""Structure the ILThermo heat capacity at vapor saturation pressure raw file into a cleaned CSV output."""
...
PROPERTY_SLUG = "heat_capacity_at_vapor_saturation_pressure"
PROPERTY_NAME_PAT = r"Heat capacity at vapor saturation pressure"
