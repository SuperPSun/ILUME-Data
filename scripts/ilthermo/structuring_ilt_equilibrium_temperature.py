"""Structure the ILThermo equilibrium temperature raw file into a cleaned CSV output."""
...
PROPERTY_SLUG = "equilibrium_temperature"
PROPERTY_NAME_PAT = r"Equilibrium temperature"
...
_standardize_property_value = build_converter_standardizer(
    quantity_name="equilibrium temperature",
    output_unit="K",
    converter=to_kelvin,
)
