"""Structure the ILThermo refractive index raw file into a cleaned CSV output."""
...
PROPERTY_SLUG = "refractive_index"
PROPERTY_NAME_PAT = r"Refractive index \(Na D-line\)"
