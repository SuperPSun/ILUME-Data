"""Structure the ILThermo enthalpy of vaporization or sublimation raw file into a cleaned CSV output."""
...
PROPERTY_SLUG = "enthalpy_of_vaporization_or_sublimation"
