"""Structure the ILThermo speed of sound raw file into a cleaned CSV output."""
...
PROPERTY_SLUG = "speed_of_sound"
PROPERTY_NAME_PAT = r"Speed of sound"
